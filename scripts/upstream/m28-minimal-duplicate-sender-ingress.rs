// M28 — minimum-witness production-ingress boundary probe, injected into the pinned upstream
...
#[cfg(test)]
mod m28_minimal_duplicate_sender_ingress {
    ...
    #[tokio::test]
    async fn m28_minimal_duplicate_sender_candidate_crosses_block_receiver() {
        ...
        // The receiver has crossed only the ingress boundary here. M21/M25
        // characterize the sender-cardinality differential separately.
    }
}
